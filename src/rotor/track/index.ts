...
export class Track {
	 ...
	 */
	@log()
	public async started(station: string, track_id: string, total: number = 0, batch_id: string): Promise<any> {
	 ...
	 */
	@log()
	public async finished(station: string, track_id: string, total: number = 0, batch_id: string): Promise<string> {
	 ...
	 */
	@log()
	public async skip(station: string, track_id: string, total: number = 0, batch_id: string): Promise<string> {
